...
<body>
    ...
    <div class="container">
        <div class="col-md-4 mx-auto">
            <form method="post" action="Modifier_produit.php?IDProduit=<?= $produit['IDProduit'] ?>">
                ...
                <select class="form-select mb-4 " id="selectType" name="Type" aria-label="Sélectionnez un type">
                    <option value="Fruit" <?= ($produit['Type'] == 'Fruit') ? 'selected' : '' ?>>Fruit</option>
                    <option value="Légume" <?= ($produit['Type'] == 'Légume') ? 'selected' : '' ?>>Légume</option>
                </select>
